...
public class test456{
	...
	public test456() {
		...
		JPanel c_panel = new JPanel(); /*
										 * { protected void paintComponent(Graphics g) { ImageIcon icon = new
										 * ImageIcon("C:/workspace/Java_workspace/TeamProject/src/res/bg_test.jpg");
										 * Image img = icon.getImage(); img = img.getScaledInstance(WIDTH, HEIGHT,
										 * Image.SCALE_SMOOTH); g.drawImage(img, 0, 0, this); setOpaque(false);
		...
		t_pass.setBounds(101, 319, 231, 48);
		c_panel.add(t_pass);
