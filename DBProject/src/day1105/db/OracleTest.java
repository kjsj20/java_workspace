...
public class OracleTest{
	...
	Connection con = null; //메서드의 지역변수라서 반드시 초기화해야 함(멤버 변수처럼 자동으로 해주는일없다!!)
	...
	try{
		...
		if(con==null){
			...
			sql += " values(seq_member.nextval, '김질성', '16', '01029408805')";
			...
			//따라서 insert의 경우 반환값이 1, update, delete는 몇건이 영향 받았는지 알수는 없다.. 조건에 따라 틀림
