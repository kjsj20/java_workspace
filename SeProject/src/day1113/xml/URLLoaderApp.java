...
public class URLLoaderApp {
	...
	public URLLoaderApp() {
		try {
			url = new URL("https://www.sciencetimes.co.kr/wp-content/uploads/2020/06/GettyImages-1184658902-scaled.jpg");
			//지정한 원격지의 자원과 연결을 시도!!!
