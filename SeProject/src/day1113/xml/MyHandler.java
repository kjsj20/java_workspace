...
//		System.out.print("<"+tag+">");
		...
		if(tag.equals("pets")) {
			...
			pet = new Pet();
		} else if (tag.equals("type")) {//하나의 pet 인스턴스 생성할 타임이다!!
			//시작 태그를 지금 지나가고 있음을 알려주자!!
			isType = true;
		} else if (tag.equals("name")) {//하나의 pet 인스턴스 생성할 타임이다!!
			isName = true;
		} else if (tag.equals("age")) {//하나의 pet 인스턴스 생성할 타임이다!!
			isAge = true;
		} else if (tag.equals("gender")) {//하나의 pet 인스턴스 생성할 타임이다!!
			isGender = true;
		}
	}
