/*
 * Cpllection Framework(전제 조건은 객체만을 대상으로 한다.)
 * -자바언어에서는 객체를 모아서 처리할때 유용한 api를 지원하는데, 이 api를 가리켜 컬렉션 프레임워크라 한다.
 * 그리고 java.utill 에서 지원한다.
...
public class CollectionApp {
	...
	public void showList() {
		//List형의 최상위 객체인 List는 인터페이스이며, List로 기본적으로 가져야할 추상 메서드가 명시되어 있다..
