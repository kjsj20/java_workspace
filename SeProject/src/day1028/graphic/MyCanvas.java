...
public class MyCanvas extends Canvas {
	Toolkit kit; //플랫폼(win, mac, linux)에 따라 알맞게 자원을 가져올 수 있도록 해주는 객체
	Image img;
	
	public MyCanvas() {
		kit = Toolkit.getDefaultToolkit(); //자체 클래스 메서드(static)를 통해 인스턴스 얻는 방식!
		img = kit.getImage("D:/java_workspace/SeProject/res/travel2/aa.jpg"); 
	}
	...
	public void paint(Graphics g) {
		...
		//			Toolkit객체를 이용해야 하므로 , 이미지를 얻기전에 우선 툴킷 객체의 인스턴스부터 얻자!
