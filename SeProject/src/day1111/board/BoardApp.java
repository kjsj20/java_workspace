...
public class BoardApp extends JFrame{
	...
	public BoardApp() {
		//생성
		p_north = new JPanel();
		bt_board = new JButton(ImageUtil.getIcon(this.getClass(), "res/board.png", 90, 45));
		bt_regist = new JButton(ImageUtil.getIcon(this.getClass(), "res/register.png", 90, 45));
		bt_login = new JButton(ImageUtil.getIcon(this.getClass(), "res/login.png", 90, 45));
		p_center = new JPanel();
		...
		pages[4] = new Login(this); //회원가입 페이지
		...
		//이벤트 구현식 , 재정의할 메서드가 달랑 1개인 경우 굳이, 내부익명클래스라는 표기를
